// Function to toggle subject inputs visibility
...
// Core calculation logic shared by screen display and PDF
function calculateScore() {
    ...
    // Marks calculation based on Total Questions and Max Marks
    const marksPerCorrect = totalQs > 0 ? (maxMarks / totalQs) : 0;
    
    // Penalty calculation based on selected ratio (e.g., 0.25 for 1/4)
...
async function downloadPDF() {
    // Ensure we have the latest calculations before generating PDF
    ...
    img.onerror = function() {
        // Save even if stamp fails to load
        doc.save(`${student}_Official_E7_Report.pdf`);
    };
}
